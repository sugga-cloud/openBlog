...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto flex flex-col">
    <div class="lg:w-4/6 mx-auto">
        <h1 style="font-size:2rem;font-weight:bolder">{{ $blog['title'] }}</h1>
      <div class="rounded-lg h-64 overflow-hidden">
        <img alt="content" class="object-cover object-center h-full w-full" src="{{ $blog['url'] }}">
      </div>
      <div class="flex flex-col sm:flex-row mt-10">
        <div class=" sm:pl-8  sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
          <p class="leading-relaxed text-lg mb-4">{{ $blog['content'] }}</p>
  ...
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
        ...
        <div class="p-2 w-full">
          <div class="relative">
            <input type="text" value="{{ $blog['blog_id'] }}" name="id" hidden>
